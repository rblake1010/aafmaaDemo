...
function bavotasan_default_theme_options() {
	//delete_option( 'theme_mods_national_basic' );
	return array(
		'width' => '1170',
		'layout' => 'right',
		'primary' => 'col-md-9',
...
class Bavotasan_Customizer {
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_section( 'bavotasan_layout', array(
			'title' => __( 'Layout', 'national-basic' ),
			'priority' => 35,
		) );
		...
		$wp_customize->add_control( 'width', array(
			'label' => __( 'Site Width', 'national-basic' ),
			'section' => 'bavotasan_layout',
			'priority' => 10,
			'type' => 'select',
			'choices' => array(
				'1170' => __( '1200px', 'national-basic' ),
				'992' => __( '992px', 'national-basic' ),
			),
		) );
		...
		$wp_customize->add_control( 'primary', array(
			'label' => __( 'Main Content Width', 'national-basic' ),
			'section' => 'bavotasan_layout',
			'priority' => 15,
			'type' => 'select',
			'choices' => $choices,
		...
		$layout_choices = array(
			'left' => __( 'Left', 'national-basic' ),
			'right' => __( 'Right', 'national-basic' ),
		);

		$wp_customize->add_control( new Bavotasan_Post_Layout_Control( $wp_customize, 'layout', array(
			'label' => __( 'Sidebar Layout', 'national-basic' ),
			'section' => 'bavotasan_layout',
			'settings' => 'layout',
			'priority' => 25,
	...
	public function customize_controls_enqueue_scripts() {
        ...
        wp_localize_script( 'bavotasan-customizer', 'Bavotasan_Customizer', array(
            'upgradeAd' => __( 'Upgrade to premium version', 'national-basic' ),
        ));
